...
<p align="center">
  <a href="https://be-the-hero-backend-lourival.herokuapp.com/">Backend API</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
  <a href="https://nervous-franklin-af4db7.netlify.com/">Frontend</a>
</p>
...
- Controle de rotas
- Exbir e salvar imagens com AWS S3
- Deploy da aplicação NodeJS no Herokuapp e Netlify
- Deploy da aplicação ReactJS no Netlify
...
Feito por Lourival, através do curso Omnistack 9.0 by Rocketseat :wave:
